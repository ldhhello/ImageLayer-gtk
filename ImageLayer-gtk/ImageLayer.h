...
static const ImageLayer DEFAULT_IMAGE_LAYER = { NULL, 0, RGB(0,0,0) , NULL, NULL, NULL, _initialize, _renderAll, NULL, NULL, NULL,//_renderAndFadeIn, _renderAndFadeOut, NULL,
